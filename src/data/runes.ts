...
export const runes: Rune[] = [
  // 의식의 룬 — 전설
  { slug: 'bach', name: '바크', cost: 23, rarity: 'legendary', type: 'ritual',
    resource: '50 공물', trigger: '5미터 이동 시', effect: '자원 누적',
    iconSrc: `${ICON}/ritual-bach.webp`, tooltipSrc: `${TIP}/ritual/bach.webp` },
  { slug: 'igni', name: '이그니', cost: 17, rarity: 'legendary', type: 'ritual',
  ...
  { slug: 'neho', name: '네호', cost: 59, rarity: 'rare', type: 'ritual',
  ...
  { slug: 'nok', name: '녹', cost: 80, rarity: 'rare', type: 'ritual',
  ...
  { slug: 'ja', name: '자', cost: 24, rarity: 'legendary', type: 'invocation',
  ...
  { slug: 'oum', name: '오움', cost: 31, rarity: 'legendary', type: 'invocation',
  ...
  { slug: 'vex', name: '벡스', cost: 19, rarity: 'legendary', type: 'invocation',
  ...
  { slug: 'yom', name: '윰', cost: 8, rarity: 'legendary', type: 'invocation',
  ...
  // 기원의 룬 — 희귀
  { slug: 'kel', name: '켈', cost: 53, rarity: 'rare', type: 'invocation',
  ...
  { slug: 'rak', name: '라크', cost: 67, rarity: 'rare', type: 'invocation',
  ...
  { slug: 'mot', name: '모트', cost: 63, rarity: 'rare', type: 'invocation',
  ...
  { slug: 'kume', name: '쿠메', cost: 71, rarity: 'rare', type: 'invocation',
  ...
  { slug: 'jul', name: '주울', cost: 80, rarity: 'rare', type: 'invocation',
  ...
  // 기원의 룬 — 마법
  { slug: 'wat', name: '와트', cost: 73, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'seh', name: '세흐', cost: 76, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'gar', name: '가르', cost: 73, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'krami', name: '크라미', cost: 99, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'ner', name: '네르', cost: 77, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'prid', name: '프리드', cost: 101, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'kuma', name: '쿠마', cost: 95, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'teb', name: '테브', cost: 91, rarity: 'magic', type: 'invocation',
  ...
  { slug: 'chik', name: '치크', cost: 91, rarity: 'magic', type: 'invocation',
